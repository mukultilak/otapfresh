        ...
        <div style="color:#f5f5f5;border-radius:4px">
            ...
            <div class="panel panel-default" >
                    <div class="panel-heading">
                        <div class="panel-title">Student Sign Up </div>
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        {!!Form::open(array('url'=>'register','id'=>'login-form','class'=>'form-horizontal','role'=>'form','data-toggle'=>'validator'))!!}


                            <div class="form-group" style="padding:0 15px;margin-bottom:0">
                            <div style="margin-bottom: 25px" class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                {!!Form::text('grno','',array('id'=>'login-username','placeholder'=>'G.R Number','class'=>'form-control','required'=>'required','data-error'=>'Enter your GR Number'))!!}
                            </div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                {!!Form::text('fname','',array('id'=>'login-username','placeholder'=>'First Name','class'=>'form-control','required'=>'required','data-error'=>'Enter First Name'))!!}
                            </div>
                            <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                {!!Form::text('mname','',array('id'=>'login-username','placeholder'=>'Middle Name','class'=>'form-control'))!!}
                            </div>
                            <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                {!!Form::text('lname','',array('id'=>'login-username','placeholder'=>'Last Name','class'=>'form-control','required'=>'required','data-error'=>'Enter last name'))!!}
                            </div>
                            <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                              ...
                              {!!Form::email('email','',array('id'=>'login-email','placeholder'=>'Email','class'=>'form-control','required'=>'required'))!!}
                            </div>
                            </div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                               <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                 {!! Form::password('password1', array('class' => 'form-control','placeholder'=>'Re-enter password','required'=>'required')) !!}
                            </div>
                            </div>
